...
#     client_package = importlib.import_module("watson_nlp_runtime_client")
#     service_pb2 = getattr(client_package, "common_service_pb2")

#     print("service_pb2 is: ", dir(service_pb2))
