...
class TestRelevantText(TestCaseBase):
    ...
    def test_fields(self):
        self.assertTrue(utils.validate_fields(self.expl))
...
class TestCategory(TestCaseBase):
    ...
    def test_fields(self):
        self.assertTrue(utils.validate_fields(self.category1))
        self.assertTrue(utils.validate_fields(self.category2))
...
class TestCategoriesPrediction(TestCaseBase):
    ...
    def test_fields(self):
        self.assertTrue(utils.validate_fields(self.categories_prediction))
        self.assertTrue(utils.validate_fields(self.categories_prediction_minimal))
