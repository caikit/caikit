...
class ConnectionInfo(DataObjectBase):
    ...
    # TLS Settings
    tls:  Annotated[Optional[ConnectionTlsInfo], FieldNumber(3)] = field(default_factory=ConnectionTlsInfo)
    
    # Connection timeout settings
    timeout: Annotated[Optional[int], FieldNumber(4)] = 60
    
    # Any extra options for the connection
    options: Annotated[Optional[Dict[str, str]], FieldNumber(5)] = field(default_factory=dict)
