        ...
        if not issubclass(cls, Enum):
            ...
            for annotation in getattr(cls, "__annotations__", {}):
                ...
                if defined_default == dataclasses.MISSING:
                    ...
                    # If this class is a dataclass and this field has dataclass specific field defaults
                    # then use those. Because of how dataclasses wrapping is you have to check default
                    # and default_factory directly
                    if defined_default != dataclasses.MISSING and (
                        defined_default.default != dataclasses.MISSING or defined_default.default_factory != dataclasses.MISSING
                    ):
